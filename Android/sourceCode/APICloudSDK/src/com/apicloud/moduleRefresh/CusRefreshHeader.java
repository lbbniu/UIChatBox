...
public class CusRefreshHeader extends RefreshHeader{
	...
	class DefaultHeader extends RelativeLayout{
		...
		DefaultHeader(Context context) {
			...
			RelativeLayout.LayoutParams llrlp = new RelativeLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
			...
			RelativeLayout.LayoutParams prlp = new RelativeLayout.LayoutParams(size, size);
			...
			prlp = new RelativeLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
			prlp.addRule(RelativeLayout.CENTER_IN_PARENT, RelativeLayout.TRUE);
		...
		private void setImage(Drawable drawable){
			...
			if(null != drawable){
				...
				int refresh = UZResourcesIDFinder.getResDrawableID("mo_cus_refresh_default");
				if(refresh > 0){
